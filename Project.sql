...
CREATE TABLE EMERGENCY_PHONE_NUMBER (
	...
	FOREIGN KEY (StudentID, EC_Name) REFERENCES student_emergency_contact (StudentID, EC_Name)
		ON UPDATE CASCADE
		ON DELETE CASCADE,
	PRIMARY KEY(StudentID, EC_Name, EC_Phone)
	);

CREATE TABLE EMERGENCY_EMAIL (
	StudentID INTEGER NOT NULL,
	EC_Name VARCHAR(40) NOT NULL,
	...
	FOREIGN KEY (StudentID, EC_Name) REFERENCES student_emergency_contact (StudentID, EC_Name)
		ON UPDATE CASCADE
		ON DELETE CASCADE,
	PRIMARY KEY(StudentID, EC_Name, EC_Email)
	);
